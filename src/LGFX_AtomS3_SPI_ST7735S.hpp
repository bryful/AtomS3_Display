#pragma once
#ifndef LGFX_ATOMS3_SPI_ST7735S
#define LGFX_ATOMS3_SPI_ST7735S
...
constexpr int PIN_CS = 38;  // Backlight
// -----------------------------------------------------------------------------
/* https://qiita.com/nobrin/items/c9490a2d1e16e849c5c2 の記事を参考に
 */
class LGFX_AtomS3_SPI_ST7735S : public lgfx::LGFX_Device
{
